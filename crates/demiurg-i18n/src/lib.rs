...
const fn en(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::ExtractToAttachment => "Extract to layer",
...
const fn ru(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::MoveAttachment => "Двигать слой",
        Msg::Size => "Размер",
        ...
        Msg::ExtractToAttachment => "Вырезать в слой",
