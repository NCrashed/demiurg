...
const fn en(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::ExportClip => "Export clip (.rvc)…",
        Msg::Clip => "Clip",
        Msg::Frames => "Frames",
        Msg::Frame => "Frame",
        Msg::AddFrame => "+ Frame",
        Msg::DuplicateFrame => "Duplicate",
        Msg::DeleteFrame => "Delete frame",
        Msg::FrameMs => "Frame ms",
        ...
        Msg::ImportClipLayer => "Import .rvc",
        Msg::Speed => "Speed",
        Msg::Phase => "Phase ms",
        ...
        Msg::Easing => "Easing",
        Msg::EaseLinear => "Linear",
        Msg::EaseIn => "In",
        Msg::EaseOut => "Out",
        Msg::EaseInOut => "In-out",
        Msg::Rig => "Rig",
        Msg::Bones => "Bones",
...
const fn ru(msg: Msg) -> &'static str {
    match msg {
        ...
        Msg::ExportClip => "Экспорт клипа (.rvc)…",
        Msg::Clip => "Клип",
        Msg::Frames => "Кадры",
        Msg::Frame => "Кадр",
        Msg::AddFrame => "+ Кадр",
        Msg::DuplicateFrame => "Дублировать",
        Msg::DeleteFrame => "Удалить кадр",
        Msg::FrameMs => "Кадр, мс",
        ...
        Msg::ImportClipLayer => "Импорт .rvc",
        Msg::Speed => "Скорость",
        Msg::Phase => "Фаза, мс",
        ...
        Msg::Easing => "Сглаживание",
        Msg::EaseLinear => "Линейно",
        Msg::EaseIn => "Вход",
        Msg::EaseOut => "Выход",
        Msg::EaseInOut => "Вход-выход",
        Msg::Rig => "Риг",
        Msg::Bones => "Кости",
